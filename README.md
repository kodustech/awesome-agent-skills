...
| [agent-starter](https://github.com/sneg55/agent-starter) | Skills, hooks, templates, and guides for bootstrapping AI-agent-friendly projects. Includes `/new-project` scaffolding, `/adopt-project` for existing repos, AI-tuned lint rules, and a per-project self-improvement loop. |
