...
| [x-skills](https://github.com/sergebulaev/x-skills) | Six MIT-licensed agent skills for X (Twitter) content work in Claude Code, Codex, and other SKILL.md agents: post writer, thread builder, humanizer that scrubs AI tells with a pre-publish audit, reply drafter, hook extractor, and content planner. Use when drafting, auditing, or planning X posts and threads from a coding agent. |
