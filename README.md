...
| [penthera](https://github.com/danoszz/penthera/tree/main/skills/penthera) | Security scanner for web apps. Use when the user asks to scan, audit, or pentest their own app, staging URL, localhost, or repo. Covers TLS, security headers, auth hardening, secret scanning, IDOR/OAuth, and injection probes, maps findings to OWASP WSTG, and exports SARIF. Runs as a Claude/Cursor skill or CLI. Authorized testing only. |
