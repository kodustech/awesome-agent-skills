...
| Skill | Description |
|-----------|-----------|
| [agent-qa-authoring](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-authoring) | Creates, edits, validates, and runs agent-qa tests, suites, and hooks using canonical IDs and MCP-backed schemas. |
| [agent-qa-debug-fix](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-debug-fix) | Debugs failed agent-qa runs from MCP evidence, patches the smallest root cause, and verifies the affected test. |
| [agent-qa-result-triage](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-result-triage) | Classifies failed agent-qa runs from logs, steps, and artifacts and returns evidence-backed next actions. |
