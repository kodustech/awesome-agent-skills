...
| Skill | Description |
|-----------|-----------|
| [agent-workflow-pack](https://github.com/MemoAsh/agent-workflow-pack/tree/main/examples/pr-review-workflow) | Reusable PR review workflow pack with AGENTS.md, SKILL.md, templates, and verification checks. |
