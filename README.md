...
| [x-research](https://github.com/agentbody/skills/tree/main/skills/x-research) | Read-only X/Twitter research: public post search, trends, post details, profiles, profile posts/media, and replies. Use when a user asks to search X/Twitter, monitor a topic or account, inspect a post, or gather current X evidence. |
