...
| Skill | Description |
|-----------|-----------|
| [suede-code](https://github.com/JasonColapietro/suede-creator-skills/tree/main/skills/suede-code) | Review and grade code in one pass with evidence-backed findings, an A-F ship verdict, OWASP checks, deploy-safety review, and fix briefs. |
