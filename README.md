...
| Skill | Description |
|-----------|-----------|
| [accessibility](https://github.com/wundercorp/accessibility-skill) | Inclusive UI accessibility guidance for semantic HTML, ARIA, keyboard navigation, focus management, screen-reader behavior, accessible forms, reduced motion, landmarks, live regions, and assistive-technology-friendly components. Install: `npx --yes skills add https://github.com/wundercorp/accessibility-skill --skill accessibility`. |
| [contrast-guard](https://github.com/wundercorp/contrast-guard-skill) | UI legibility and contrast-safety guidance for preventing unreadable foreground/background pairings, theme-toggle contrast regressions, risky overlays, accidental palette leakage, and low-contrast interactive states. Install: `npx --yes skills add https://github.com/wundercorp/contrast-guard-skill --skill contrast-guard`. |
| [batman](https://github.com/wundercorp/batman-skill) | Dark-mode-first website theming guidance for accessible light/dark switches, root theme contracts, no-flash initialization, persisted preferences, semantic tokens, and common theming pitfall prevention. Install: `npx --yes skills add https://github.com/wundercorp/batman-skill --skill batman`. |
| [themable](https://github.com/wundercorp/themable-skill) | Website theme palette guidance for switchable theme families, semantic token utilities, accessible palette pickers, persisted preferences, CSS variable generation, and theme anti-pattern prevention. Install: `npx --yes skills add https://github.com/wundercorp/themable-skill --skill themable`. |
| [bauhaus](https://github.com/wundercorp/bauhaus-skill) | Bold visual design language guidance for modern premium interfaces with oversized typography, geometric composition, disciplined color systems, section-level contrast, and consistent theme expression. Install: `npx --yes skills add https://github.com/wundercorp/bauhaus-skill --skill bauhaus`. |
| [gradient-mesh](https://github.com/wundercorp/gradient-mesh-skill) | Gradient mesh website design guidance for tasteful mesh backgrounds, CSS/SVG/canvas assets, animation-safe visual systems, accessibility overlays, performance budgets, and optional Python mesh workflows. Install: `npx --yes skills add https://github.com/wundercorp/gradient-mesh-skill --skill gradient-mesh`. |
| [linguist](https://github.com/wundercorp/linguist-skill) | Internationalization implementation guidance for multilingual sites with locale routing, translation keys, fallback languages, formatting, SEO hreflang metadata, extraction checks, and localization documentation. Install: `npx --yes skills add https://github.com/wundercorp/linguist-skill --skill linguist`. |
...
| Skill | Description |
|-----------|-----------|
| [cloud-deployment-shipyou](https://github.com/wundercorp/cloud-deployment-shipyou-skill) | Deployment-readiness guidance for containerizing apps, producing Docker-friendly source bundles, adding health checks, and preparing projects for ShipYou handoff. Install: `npx --yes skills add https://github.com/wundercorp/cloud-deployment-shipyou-skill --skill cloud-deployment-shipyou`. |
...
| Skill | Description |
|-----------|-----------|
| [doctor](https://github.com/wundercorp/doctor-skill) | Runtime dependency doctor and generated-app auto-healing guidance for unresolved imports, missing packages, stale installs, package drift, lockfile drift, Vite import-analysis errors, module-not-found failures, and dev-server preview failures. Install: `npx --yes skills add https://github.com/wundercorp/doctor-skill --skill doctor`. |
...
| Skill | Description |
|-----------|-----------|
| [svalbard](https://github.com/wundercorp/svalbard-skill) | Security-first application architecture and hardening guidance for secure-by-default apps, authentication, authorization, input validation, browser headers, secrets, data protection, abuse controls, containers, CI/CD, and release verification. Install: `npx --yes skills add https://github.com/wundercorp/svalbard-skill --skill svalbard`. |
| [patcher](https://github.com/wundercorp/patcher-skill) | Severity-ordered vulnerability patching guidance for Docker containers, dependency CVEs, zero-day mitigations, frontend security issues, backend package vulnerabilities, CI/CD supply-chain risks, and exploitable codebase issues. Install: `npx --yes skills add https://github.com/wundercorp/patcher-skill --skill patcher`. |
| [cleaner](https://github.com/wundercorp/cleaner-skill) | Public-release repository cleaning guidance for removing OS junk, archive metadata, caches, logs, local deployment state, private env files, local databases, dependency artifacts, build clutter, and secret-like content before public pushes or deployments. Install: `npx --yes skills add https://github.com/wundercorp/cleaner-skill --skill cleaner`. |
...
| Skill | Description |
|-----------|-----------|
| [ogilvideo](https://github.com/wundercorp/ogilvideo-skill) | Motion-director-grade video analysis, storyboarding, prompt engineering, animation planning, agentic AI video direction, UI motion systems, production breakdowns, and QA for premium product videos and motion graphics. Install: `npx --yes skills add https://github.com/wundercorp/ogilvideo-skill --skill ogilvideo`. |
...
| [hermes-tweet](https://github.com/Xquik-dev/hermes-tweet) | Native Hermes Agent plugin for X/Twitter workflows: public reads, post inspection, timeline exploration, and explicitly gated tweet actions through Xquik. |
| [kol-pricing](https://github.com/unifapi-agent/skills/tree/main/skills/kol-pricing) | Price creator campaigns with public social data from UnifAPI MCP workflows. |
...
| [vibe-creating-prompt](https://github.com/Alisa0808/vibe-creating-skill) | Bilingual (EN/中文) skill that rewrites a rough idea or an over-specified shot script into a model-ready text-to-video prompt. Use when generating prompts for text-to-video models such as Seedance 2.0, Kling, Veo, Hailuo, Wan, or Vidu. Judgment-first: declines UI demos, tutorials, and exact dialogue-sync. Single SKILL.md, MIT. |
...
| Skill | Description |
|-----------|-----------|
| [professional-developer](https://github.com/wundercorp/professional-developer-skill) | Production-grade development guidance for clean structure, formatting, design patterns, testing, maintainability, and professional code review behavior. Install: `npx --yes skills add https://github.com/wundercorp/professional-developer-skill --skill professional-developer`. |
| [wiring](https://github.com/wundercorp/wiring-skill) | Application wiring sanity checks and repair guidance for run commands, entry points, imports, CSS and asset references, dependencies, routes, environment variables, build configuration, monorepo links, Docker files, and deployment paths. Install: `npx --yes skills add https://github.com/wundercorp/wiring-skill --skill wiring`. |
| [mimar](https://github.com/wundercorp/mimar-skill) | Architecture documentation generation guidance for creating and maintaining `ARCHITECTURE.md` files with diagrams, directory maps, run flows, dependency maps, feature boundaries, implementation notes, and codebase design explanations. Install: `npx --yes skills add https://github.com/wundercorp/mimar-skill --skill mimar`. |
| [archivist](https://github.com/wundercorp/archivist-skill) | Repository history and change-maintenance guidance for keeping changelogs, change records, release notes, ADRs, migration notes, API notes, deployment notes, and GitHub review templates up to date whenever codebases change. Install: `npx --yes skills add https://github.com/wundercorp/archivist-skill --skill archivist`. |
| [coherence](https://github.com/wundercorp/coherence-skill) | Prompt, skill, and technology-direction reconciliation guidance for turning mismatched requirements, overlapping skills, contradictory instructions, and implementation anti-patterns into a coherent implementation strategy. Install: `npx --yes skills add https://github.com/wundercorp/coherence-skill --skill coherence`. |
