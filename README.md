...
| [golang-curated-agent-skills](https://github.com/matdev83/golang-curated-agent-skills) | Curated, portable set of 44 Go(lang) Agent Skills (concurrency, context, testing, benchmarks, gRPC, security, idiomatic style) for Claude Code, Codex, Cursor, OpenCode, and Gemini CLI. |
