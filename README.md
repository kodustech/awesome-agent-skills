...
| [setup-open-index](https://github.com/DrDroidLab/open-index/blob/main/skills/setup-open-index/SKILL.md) | Install and configure structured context graphs with read/write MCP access for domain-specific agents. |
