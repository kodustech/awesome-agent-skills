...
| [ontoly](https://github.com/0xsarwagya/ontoly/tree/main/skills) | Deterministic Software Graph and Agent Skills for architecture summaries, route tracing, dependency analysis, configuration usage, and impact analysis before broad source search. |
