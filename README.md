...
| [Thermal Machinery AI Skills](https://github.com/YYch89/thermal-machinery-ai-skills) | Two Codex-compatible skills for staged, auditable MATLAB/Simulink modeling of gas turbines and coupled thermal systems: topology, design point, steady closure, dynamic initialization, maps, and validation gates. Includes synthetic public examples. |
