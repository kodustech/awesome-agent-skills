...
| [routerbase-agent-skills](https://github.com/zenlee123/routerbase-agent-skills) | Agent skills for using [routerbase](https://routerbase.com/) as an OpenAI-compatible gateway, model routing layer, and media generation interface. |
