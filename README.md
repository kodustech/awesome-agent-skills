...
| [symcli-skill](https://github.com/Wowo51/Sym/tree/main/Skills/symcli-skill) | Pure C# deterministic "System 2" mathematical reasoning and code analyzer skill to prevent LLM hallucination. |
