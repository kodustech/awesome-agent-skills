...
| [find-agent-skills](https://github.com/CarlosJunioor/skillZs/tree/main/skills/find-agent-skills) | Find, compare, and safely evaluate reusable Agent Skills for Claude Code, Codex, Cursor, Copilot, and Gemini CLI using the [skillZs directory](https://skillzs.dev/browse), source manuals, install data, and audit summaries. |
