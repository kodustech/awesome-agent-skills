...
| [runapi-cli](https://github.com/runapi-ai/cli-skill) | Generate AI images, videos, music/audio, and other model API jobs with the RunAPI CLI from Claude Code, Codex, Gemini CLI, Cursor, and similar agents. |
